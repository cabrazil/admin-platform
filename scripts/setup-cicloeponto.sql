-- Script de Setup do CicloePonto Blog
...
-- 2. Criar Artigos de Exemplo
INSERT INTO "Article" (title, slug, description, content, "imageUrl", "categoryId", "blogId", status, "createdAt", "updatedAt") VALUES
...
-- 3. Verificar se as categorias e artigos foram criados
SELECT 'Categorias criadas:' as info, COUNT(*) as total FROM "Category" WHERE "blogId" = 4;
SELECT 'Artigos criados:' as info, COUNT(*) as total FROM "Article" WHERE "blogId" = 4;
